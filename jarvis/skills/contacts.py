...
class ContactsSkill(Skill):
    ...
    def description(self) -> str:
        return (
            ...
            "Когда пользователь говорит 'напиши моей девушке' — ищи по label='девушка'."
        )
    ...
    def parameters(self) -> dict[str, Any]:
        return {
            ...
            "properties": {
                ...
                "label": {
                    "type": "string",
                    "description": "Метка-роль: девушка, мама, друг, коллега, босс и т.д.",
                },
            },
            "required": ["action"],
        }
    ...
    def _add(self, name: str, telegram_id: str, label: str) -> str:
        contacts = self._load()
    ...
    def _format_contact(contact: dict[str, str]) -> str:
        ...
        tg_str = f" → Telegram: {contact['telegram_id']}" if contact.get("telegram_id") else ""
